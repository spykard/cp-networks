...
for key in meanAccNoiseOffline.keys():
	tab1.append([key,meanAccNoiseOffline[key]])
	tab2.append([key,sdANoiseOffline[key]])
	tab3.append([key,meanAccNoiseOfflineLog[key]])
	tab4.append([key,sdANoiseOfflineLog[key]])
tab1.sort()
tab2.sort()
tab3.sort()
tab4.sort()
