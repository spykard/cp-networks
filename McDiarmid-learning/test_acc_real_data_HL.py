...
fileTest = open("Tests/test_acc_sushi_10000_Offline.dat","w")
for numberOfParentsForLearnedCPNet in [0,1,2]:
	...
	fileTest.write(str(numberOfParentsForLearnedCPNet) + " " + str(aOffline[0]) + " " + str(sdAOffline[0]) + "\n")
fileTest.close()

fileTest = open("Tests/test_acc_sushi_20000_Offline.dat","w")
for numberOfParentsForLearnedCPNet in [0,1,2]:
...
fileTest = open("Tests/test_acc_hotels_10000_Offline.dat","w")
...
fileTest = open("Tests/test_acc_hotels_20000_Offline.dat","w")
for numberOfParentsForLearnedCPNet in [0,1,2,3,4,5,6]:
