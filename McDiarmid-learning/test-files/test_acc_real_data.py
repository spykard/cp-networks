...
fileTestHL = open("Tests/test_acc_sushi_10000_Offline.dat","w")
fileTestOL = open("Tests/test_acc_sushi_10000_Online.dat","w")
...
fileTestHL = open("Tests/test_acc_sushi_20000_Offline.dat","w")
fileTestOL = open("Tests/test_acc_sushi_20000_Online.dat","w")
for numberOfParentsForLearnedCPNet in [0,1,2]:
...
fileTestHL = open("Tests/test_acc_hotels_10000_Offline.dat","w")
fileTestOL = open("Tests/test_acc_hotels_10000_Online.dat","w")
...
fileTestHL = open("Tests/test_acc_hotels_20000_Offline.dat","w")
fileTestOL = open("Tests/test_acc_hotels_20000_Online.dat","w")
for numberOfParentsForLearnedCPNet in [0,1,2,3,4,5,6]:
