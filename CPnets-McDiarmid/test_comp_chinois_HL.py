...
for numberOfComparisons in [50,500,1000]:
	fileTestHL.write(str(numberOfComparisons) + " comparisons:\n")
	...
	for i in percentageOfNoise:
		fileTestHL.write(str(i) + " " + str(aOffline[i]) + " " + str(sdAOffline[i]) + " " + str(aOfflineLog[i]) + " " + str(sdAOfflineLog[i]) + " " + str(meanAccNoiseOffline[i]) + " " + str(sdANoiseOffline[i]) + " " + str(meanAccNoiseOfflineLog[i]) + " " + str(sdANoiseOffline[i]) + "\n")		
fileTestHL.close()
