...
numberOfComparisons = 500 # -1 = all of the comparisons in file
...
numberOfRoundsForLearningProcedure = 1000 # = percentage taken in the dataset for the bagging
...
#fileTest = open("Tests/test_comp_chinois.dat","w")
...
#fileTest.write(str(numberOfParentsForLearnedCPNet) + " " + str(aOffline[i]) + " " + str(sdAOffline[i]) + "\n")
